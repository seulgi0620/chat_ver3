...
public class CreatePanel {
	...
	ChatroomListVO clvo = null;
	
	public void initDisplay(MyChatroomList2 mcl2) {
		
		this.mcl2 = mcl2;
		
		clvo = new ChatroomListVO();
		
		SelectChatList scl = new SelectChatList();
		mcl2.chatroom_list = scl.selectChatList(mcl2.user_id);
		
		Vector<ChatroomListVO> vc = mnr_c.selectMsgCount(mcl2.user_id, mcl2.chatroom_list);
		
		MyChatroomList2.chatroom_map.clear();
		mcl2.jp.removeAll();
		
		for(int i=0;i<mcl2.chatroom_list.size();i++) {
