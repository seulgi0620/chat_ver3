...
import chat.client.method.ExitChatroom;
import chat.client.method.LastRead;
import chat.client.method.SelectLog;
import chat.client.method.SelectParticipentList;
...
public class TalkClient extends JFrame implements ActionListener {
	...
	public TalkClient (UserMainFrame umf, String chatroom_code, String user_id, String user_name) {
		...
		jl_list.setListData(spcl.selectChatList(chatroom_code));
	...
	public void initDisplay() {
		...
		SelectParticipentList spcl = new SelectParticipentList();
		participent_list           = spcl.selectChatList(chatroom_code);
		jl_list                    = new JList<String>();
		jl_list.setListData(participent_list);
